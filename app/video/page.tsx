...
const translations: Record<"he" | "en", Record<TranslationKey, string>> = {
  he: {
    ...
    faqQ1: "איך שומרים על פרטיות הילדים והחומרים?",
    faqA1: "כל החומרים נשמרים בשרת פרטי ומאובטח. רק אני ניגש אליהם, והם נמחקים לצמיתות תוך 30 יום מהאירוע. איננו מפרסמים סרטי לקוחות ללא אישור מפורש. סרט הדוגמה שמוצג כאן באתר פורסם באישור מלא של מובילי התוכנית.",
  ...
  en: {
    ...
    faqQ1: "How do you protect the kids' privacy and the materials?",
    faqA1: "All materials are kept on a private, secure server. Only I handle them (no external freelancers), and everything is permanently deleted within 30 days of the event. We do not publish client films without explicit permission. The sample film shown here on this page is published with the full consent of the program's leaders.",
