...
export const MISSIONS: Mission[] = [
  ...
  // Day 3: finale twists.
  {
    ...
    day: 3,
    type: 'text',
    title: 'משימה אישית: הודעת האיחור',
    description:
      'כתוב הודעה שבה אתה - אתה - מודיע שאתה מאחר. עם תירוץ ברמה של הילדים ("לא שמעתי", "חשבתי שאמרנו וחצי"). שעון בוטמן מפסיק לתקתק לשלושים שניות, והשופטים מודדים כמה זה כאב.',
    personalFor: 'abba',
  },
  {
    id: 'p3-ima',
  ...
  },
  {
    ...
    day: 3,
    type: 'text',
    title: 'משימה אישית: פסק דין על השופטים',
    description:
      'התהפכו היוצרות: כתבי פסק דין על שלושת השופטים - ציון ונימוק לכל אחד, בסגנונם. הם עבדו קשה כל הטיול והם רגישים מאוד לביקורת. במיוחד המשורר.',
    personalFor: 'shir',
  },
  {
    id: 'p3-moshe',
  ...
  },
  {
    ...
    day: 3,
    type: 'text',
    title: 'משימה אישית: ההימור',
    description:
      '100 שקל בדקה בבולגריה - עכשיו ההימור הגדול: נחש את הפודיום הסופי, שלושה מקומות בסדר המדויק, לפני הטקס. השופטים מנקדים על ביטחון וסטייל. קלעת בול לשלושתם? המשורר חייב לך 11.',
    personalFor: 'netanel',
  },
  {
    id: 'p3-hillel',
