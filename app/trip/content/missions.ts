...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    title: 'נחתנו כעת',
    description:
      'כתבו דיווח הגעה לצימר בסגנון הליווי הצמוד של אבא מהטיסות: עדכוני דרך, אחוזי מזוודות, ואפס נקודות. השופטים מעריכים נאמנות לסגנון.',
  },
  ...
  // ---- Personal missions (one per player, submit any day) ----
  {
    ...
    day: 1,
    type: 'text',
    title: 'משימה אישית: הנקודה',
    description:
      'כתוב הודעת ארגון אחת מלאה עם סימן פיסוק תקין בסוף כל משפט. כולל נקודות. השופטים יספרו. ההיסטוריה תשפוט.',
    personalFor: 'abba',
  },
  {
    id: 'p-ima',
