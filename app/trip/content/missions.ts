...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    day: 1,
    type: 'text',
    title: 'משימה אישית: הבדיחה שנוחתת',
    description:
      'לספר משחק מילים בקול רם, ולהביא הוכחה שמישהו באמת צחק. לא צחוק מנומס. לא "זה לא מצחיק כשאתה מביא את הבדיחה". צחוק אמיתי, עם עד מהשטח.',
    personalFor: 'ahiya',
  },
];
