...
const TEASERS: Record<PlayerId, string> = {
  abba: "מגיע עם וויז מדויק לשנייה ונקודה בסוף כל משפט. מי שעוד לא שתה מים, שישתה. עכשיו!!!",
  ...
  moshe: "נכנס לפני חמש שנים עם 'ברוכים הנמצאים' ועדיין הכי מנומס בחדר. ענה פעם P=NP ברצינות מלאה.",
  ...
  netanel: "החטיפים שלו מסומנים, ההשכמות שלו באחריותכם. הקזינו בבולגריה עדיין מחפש אותו.",
  hillel: "הכי מתוקה, אין עוררין, וזה תיעוד רשמי. 83 אימוג'י בכי על פיצה אחת, טסט ראשון לפני כולם.",
};
